# GrayStacks — Rainbet wager leaderboard

Live at **https://graystacksrewards.com/**

A one-page static site showing a $250 monthly wager leaderboard for Rainbet
affiliate code **GRAYSTACKS**. Generated from the Forge Partners leaderboard
...
| Setting | Value |
| --- | --- |
| Affiliate code | `GRAYSTACKS` |
| Referral link | https://rainbet.com?r=graystacks |
...
5. **Point the domain** at Netlify and wait for the TLS certificate. A new
   ...
   certificate is actually issued for `graystacksrewards.com` before telling anyone the
   site is live.
...
`creators/graystacks.json` in the template repo. Edit that, re-run
`node new-creator.mjs graystacks`, and copy the regenerated files over. The cycle
